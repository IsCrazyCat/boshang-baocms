...
<div class="mainScAdd ">
    ...
    <div class="tableBox">
        <form  target="x-frame" action="<?php echo U('goods/create');?>" method="post">
			...
			<script>
                ...
                $(document).ready(function(){
                    ...
                    <?php if($level_cat['2'] > 0): ?>get_category('<?php echo ($level_cat[1]); ?>','cat_id_2','<?php echo ($level_cat[2]); ?>');<?php endif; ?>
                    <?php if($level_cat['3'] > 0): ?>get_category('<?php echo ($level_cat[2]); ?>','cat_id_3','<?php echo ($level_cat[3]); ?>');<?php endif; ?>
                });
                ...
                缩略图：
                 ...
                 <td class="rgTdBt">
                    ...
                    <div style="width: 300px;height: 100px; float: left;">
                        <img id="photo_img" width="80" height="80"  src="<?php echo (($detail["photo"])?($detail["photo"]):'__ROOT__/attachs/default.jpg'); ?>" />
                        ...
                        <td class="rgTdBt">
                            ...
                            <div class="jq_uploads_img">
                                <?php if(is_array($photos)): foreach($photos as $key=>$item): ?><span style="width: 200px; height: 120px; float: left; margin-left: 5px; margin-top: 10px;"> 
                                        <img width="100" height="100" src="<?php echo ($item["photo"]); ?>">  
