        ...
        <form target="x-frame" action="<?php echo U('goods/edit',array('goods_id'=>$detail['goods_id']));?>" method="post">
            ...
            <table bordercolor="#e1e6eb" cellspacing="0" width="100%" border="1px"
                ...
                <tr>
                    ...
                    <td class="rgTdBt">
                        <input type="radio" name="data[is_reight]" value="0"
                        <?php if($detail[is_reight] == 0): ?>checked="checked"<?php endif; ?>
                        />免运费
                        <input type="radio" name="data[is_reight]" value="1"
                        <?php if($detail[is_reight] == 1): ?>checked="checked"<?php endif; ?>
                        />不免运费
                ...
                <tr>
                    ...
                    <td class="rgTdBt"><input type="text" name="data[weight]" value="<?php echo (($detail["weight"])?($detail["weight"]):''); ?>"
                                              class="manageInput"/>
                ...
                <tr>
                    ...
                    <td class="rgTdBt">
                        <select id="kuaidi_id" name="data[kuaidi_id]" class="seleFl w300">
                            ...
                            <?php if(is_array($kuaidi)): foreach($kuaidi as $key=>$var): ?><option
                                <?php if(($var["id"]) == $detail['kuaidi_id']): ?>selected="selected"<?php endif; ?>
                                value="<?php echo ($var["id"]); ?>"><?php echo ($var["name"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="lfTdBt">工作类型:</td>
                    <td>
                        <select name="data[shoplx]" id="spec_type" class="form-control seleFl w200"
                                style="width:250px;">
                            <option value="0">选择工作类型</option>
                            <?php if(is_array($goodsType)): foreach($goodsType as $k=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"
                                <?php if($goodsInfo[shoplx] == $vo[id]): ?>selected="selected"<?php endif; ?>
                ...
                <tr>
                    <td class="lfTdBt">工作属性：</td>
                    <td class="rgTdBt">
                        <table class="table table-bordered" id="goods_attr_table">
                            <tr>
                                <td>工作属性:</td>
                                <td>
                                    <select name="goods_type" id="goods_type" class="form-control seleFl w200"
                                            style="width:250px;">
                                        <option value="0">选择工作属性</option>
                                        <?php if(is_array($goodsType)): foreach($goodsType as $k=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"
                                            <?php if($goodsInfo[goods_type] == $vo[id]): ?>selected="selected"<?php endif; ?>
                                            ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </td>
                            </tr>
                ...
                <tr>
                    ...
                    <td class="rgTdBt">
                        <label><span>认证商家：</span><input type="checkbox" name="data[is_vs1]"
