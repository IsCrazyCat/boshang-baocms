...
<!--            <a mini="act" class="remberBtn_small_quxiao tudoukuaijie" href="<?php echo U('shop/buildqrcode',array('admin_id'=>$admin['admin_id']));?>">批量生成企业二维码</a>-->
<!--            <a mini="act" class="remberBtn_small_quxiao tudoukuaijie" href="<?php echo U('shop/delqrcode',array('admin_id'=>$admin['admin_id']));?>">批量删除企业二维码</a>-->
<!--        </p>-->
...
<!--                        <td>操作时间</td>-->
<!--                        <td>操作</td>-->
<!--                    <?php if(is_array($action)): foreach($action as $key=>$var): ?>-->
<!--                        <tr>-->
...
<!--                        <td>名称</td>-->
<!--                        <td>操作</td>-->
<!--                    <?php if(is_array($lists)): foreach($lists as $key=>$var): ?>-->
<!--                        <tr>-->
...
<!--        <div class="comiis_19forum_title">-->
<!--            <span class="comiis_19forum_icon"></span>-->
<!--            <h2><a href="<?php echo U('shop/index');?>">企业数据</a></h2>-->
<!--            <em>共<?php echo ($counts["shop"]); ?>个企业</em>-->
<!--        </div>-->
<!--            <div class="comiis_19forum_list">-->
<!--            <h3><a href="##">1：今日<a class="red"><?php echo ($counts["totay_shop"]); ?></a>企业申请入驻</a></h3>-->
<!--            <h3><a href="<?php echo U('shop/apply');?>">2：待审核<a class="red"><?php echo ($counts["totay_shop_audit"]); ?></a>个企业</a></h3>-->
<!--            <h3><a href="<?php echo U('shop/recognition');?>">3：待认领<a class="red"><?php echo ($counts["shoprecognition"]); ?></a>个企业</a></h3>-->
<!--            <h3><a href="<?php echo U('audit/index');?>">4：已有<?php echo ($counts["shop_audit"]); ?>企业已认证</a></h3>-->
...
<div class="comiis_19forum_top comiis_19forum_id1">
    <div class="comiis_19forum_div">
        <div class="comiis_19forum_title">
            ...
            <em>共有<?php echo ($counts['goods']); ?>个工作</em>
        </div>
            <div class="comiis_19forum_list">
            <h3><a href="<?php echo U('goods/index');?>">1：共有<?php echo ($counts['goods']); ?>个工作</a></h3>
...
<!--                <em>共有<?php echo ($counts["ele"]); ?>个外卖企业</em>-->
<!--            </div>-->
<!--                <div class="comiis_19forum_list">-->
...
<!--                <em>共有<?php echo ($counts["market"]); ?>个菜市场企业</em>-->
<!--            </div>-->
<!--                <div class="comiis_19forum_list">-->
<!--                <h3><a href="<?php echo U('market/index');?>">1：共有<?php echo ($counts["marketproduct"]); ?>个工作</a></h3>-->
...
<!--                <em>共有<?php echo ($counts["store"]); ?>个便利店企业</em>-->
<!--            </div>-->
<!--                <div class="comiis_19forum_list">-->
<!--                <h3><a href="<?php echo U('store/index');?>">1：共有<?php echo ($counts["storeproduct"]); ?>个工作</a></h3>-->
