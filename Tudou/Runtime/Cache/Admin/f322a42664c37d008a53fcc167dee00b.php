    ...
    <div class="mainScAdd">
            ...
            <table  bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;" >
             ...
             <tr>
                 ...
                 <td class="rgTdBt">
                    ...
                    <script>                                            
						var width_shopphoto = '<?php echo thumbSize($CONFIG[attachs][shopphoto][thumb],0);?>';                         
						var height_shopphoto = '<?php echo thumbSize($CONFIG[attachs][shopphoto][thumb],1);?>';                         
						var uploader = WebUploader.create({                             
						auto: true,                             
						swf: '/static/default/webuploader/Uploader.swf',                             
       ...
       <tr>
        ...
        <tr>
            ...
            <td class="rgTdBt"><input type="text" name="data[express_price]" value="<?php echo round($detail['express_price']/100,2);?>" class="scAddTextName w210" />
            <code>商城开启第三方配送模式下面有效，开启后，如果当前商品免邮或者没有获取到配送费的时候这里的费用结算给配送员，费用从结算费用中扣除，必须大于=3元</code>
            </td>
        </tr>
        <tr>
         ...
         <tr>
              <td  class="lfTdBt">全景URL地址：</td>
                ...
                <code>请填写完整的全景URL地址，带http://，填写后默认商家详情页顶部展示，不填写不展示，前台加载的是框架</code>
                </td>
        </tr>
