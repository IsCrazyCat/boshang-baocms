            ...
            <table bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  style=" border-collapse: collapse; margin:0px; vertical-align:middle; background-color:#FFF;"  >
                ...
                <?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
                    ...
                    <td class="w150">
                        ...
                        <?php if(($var["is_shop"]) == "1"): echo BA('user/frozen_gold',array("user_id"=>$var["user_id"]),'设置商户冻结金','load','remberBtn_small_quxiao',600,350);?>
                            <?php echo BA('user/gold',array("user_id"=>$var["user_id"]),'商户资金','load','remberBtn_small_quxiao',600,350); endif; ?>
