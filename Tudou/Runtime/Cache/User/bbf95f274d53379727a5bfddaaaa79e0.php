...
<ul id="shangjia_tab">
	<li style="width:14.2857142857%;"><a href="<?php echo LinkTo('goods/index',array('aready'=>999));?>" <?php if(($aready) == "999"): ?>class="on"<?php endif; ?>>全部</a></li>
    <li style="width:14.2857142857%;"><a href="<?php echo LinkTo('goods/index',array('aready'=>0));?>" <?php if(($aready) == "0"): ?>class="on"<?php endif; ?>>待付款</a></li>
    <li style="width:14.2857142857%;"><a href="<?php echo LinkTo('goods/index',array('aready'=>1));?>" <?php if(($aready) == "1"): ?>class="on"<?php endif; ?>>已付款</a></li>
    <li style="width:14.2857142857%;"><a href="<?php echo LinkTo('goods/index',array('aready'=>2));?>" <?php if(($aready) == "2"): ?>class="on"<?php endif; ?>>已发货</a></li>
    <li style="width:14.2857142857%;"><a href="<?php echo LinkTo('goods/index',array('aready'=>4));?>" <?php if(($aready) == "4"): ?>class="on"<?php endif; ?>>待退款</a></li>
    <li style="width:14.2857142857%;"><a href="<?php echo LinkTo('goods/index',array('aready'=>5));?>" <?php if(($aready) == "5"): ?>class="on"<?php endif; ?>>已退款</a></li>
    <li style="width:14.2857142857%;"><a href="<?php echo LinkTo('goods/index',array('aready'=>8));?>" <?php if(($aready) == "8"): ?>class="on"<?php endif; ?>>已完成</a></li>
</ul>
