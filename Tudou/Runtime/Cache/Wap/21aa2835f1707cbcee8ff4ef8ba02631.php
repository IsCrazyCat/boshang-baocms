...
.item-inner .item-price-row .price-price span {
	...
	<header class="top-fixed bg-yellow bg-inverse">
		...
		<?php if(empty($keyword)): ?><div class="top-title  get-map-marker">商城首页</div><?php endif; ?>
...
<div id="fullbg" class="fullbg" style="display: none; height: 250px;"><i class="pull2"></i></div>
	...
	<div class="mall-cart">
		...
		<div class="round radius-circle"><div class="badge-corner"><i class="iconfont icon-yunzhi2gouwuche"></i><span class="badge bg-red"><?php echo ($cartnum); ?></span></div></div>
		</a>
	</div>
