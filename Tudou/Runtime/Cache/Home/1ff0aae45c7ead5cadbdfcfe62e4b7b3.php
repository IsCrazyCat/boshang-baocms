...
$('#card').hover(function(){
 ...
 <div class="nav">
    ...
    <?php if(is_array($channelmeans)): foreach($channelmeans as $key=>$item): $k++; ?>
        ...
        <?php elseif($ctl == shop): ?>
        	<li class="navListAll"><span class="navListAllt">全部企业分类</span><div class="shadowy navAll"><div class="menu_fllist2">
    <?php $k = 0; ?>            
   <?php if(is_array($shopcates)): foreach($shopcates as $key=>$item): if(($item["parent_id"]) == "0"): $k++; ?>
        ...
        <?php else: ?>
       		<li class="navListAll"><span class="navListAllt">全部频道分类</span><div class="shadowy navAll">
<style>
...
<?php $areas = D('Area')->where(array('city_id'=>$city_id))->select(); $bizs = D('Business')->where(array('area_id'=>$area_id))->select(); $Area = D('Area')->where(array('area_id'=>$area_id))->find(); $Business = D('Business')->where(array('business_id'=>$business_id))->find(); ?>
...
.nearbuy_cpLi {width: 237px;padding-right: 10px;padding-bottom: 10px; display: inline-block;min-height: 370px; max-height: 370px;}
            ...
            <ul>
                <?php if(!empty($selArr)): ?><li class="goods_flListLf">
                        <ul>
                            ...
                            <?php if(!empty($cat)): ?><li class="goods_flLi goods_flLiLf"><a class="goods_flLiA" href="<?php echo LinkTo('mall/index',$linkArr,array('cat'=>$cat));?>"><?php echo ($goodscate[$cat]['cate_name']); ?><em></em></a><a href="<?php echo LinkTo('mall/index',$linkArr,array('cat'=>0));?>" class="goods_flLiFl">ｘ</a>
                                    <div class="goods_flLiLfk"><a href="<?php echo LinkTo('mall/index',array('cat'=>0));?>">全部</a>
                                        <?php if(is_array($goodscate)): foreach($goodscate as $key=>$item): if(($item["parent_id"]) == "0"): ?>|<a <?php if(($item["cate_id"]) == $cat): ?>class="on"<?php endif; ?>  href="<?php echo LinkTo('mall/index',array('cat'=>$item['cate_id'],'cate_id'=>0));?>"><?php echo ($goodscate[$item['cate_id']]['cate_name']); ?></a><?php endif; endforeach; endif; ?>
                                    </div>
                                </li>
                                <li class="goods_flLi goods_flLix">&gt;</li><?php endif; ?>

                            <?php if(!empty($cate_id)): ?><li class="goods_flLi goods_flLiLf"><a class="goods_flLiA" href="<?php echo LinkTo('mall/index',array('cat'=>$cat,'cate_id'=>$cate_id));?>"><?php echo ($goodscate[$cate_id]['cate_name']); ?><em></em></a><a href="<?php echo LinkTo('mall/index',$linkArr,array('cat'=>$cat,'cate_id'=>0));?>" class="goods_flLiFl">ｘ</a>

                                    <div class="goods_flLiLfk"><a href="<?php echo LinkTo('mall/index',array('cat'=>$cat,'cate_id'=>0));?>">全部</a>

                                        <?php if(is_array($goodscate)): foreach($goodscate as $key=>$item): if(($item["parent_id"]) == $cat): ?>|<a <?php if(($item["cate_id"]) == $cate_id): ?>class="on"<?php endif; ?> href="<?php echo LinkTo('mall/index',array('cat'=>$cat,'cate_id'=>$item['cate_id']));?>"><?php echo ($goodscate[$item['cate_id']]['cate_name']); ?></a><?php endif; endforeach; endif; ?>
                                    </div>
                                </li>
                                <li class="goods_flLi goods_flLix">&gt;</li><?php endif; ?>
                            ...
                            <?php if(!empty($area_id)): ?><li class="goods_flLi goods_flLiLf"><a class="goods_flLiA" href="<?php echo LinkTo('mall/index',$linkArr,array('area'=>$area_id));?>"><?php echo ($Area['area_name']); ?><em></em></a><a href="<?php echo LinkTo('mall/index',$linkArr,array('area'=>0,'business'=>0));?>" class="goods_flLiFl">ｘ</a>
                                    <div class="goods_flLiLfk"><a href="<?php echo LinkTo('mall/index',$linkArr,array('area'=>0));?>">全部</a>
                                        <?php if(is_array($areas)): foreach($areas as $key=>$item): if(($item["city_id"]) == $city_id): ?>|<a <?php if(($item["area_id"]) == $area_id): ?>class="on"<?php endif; ?> href="<?php echo LinkTo('mall/index',$linkArr,array('area'=>$item['area_id'],'business'=>0));?>"><?php echo ($item['area_name']); ?></a><?php endif; endforeach; endif; ?>
                                    </div>
                                </li>
                                <li class="goods_flLi goods_flLix">&gt;</li><?php endif; ?>
                            ...
                            <?php if(!empty($business_id)): ?><li class="goods_flLi goods_flLiLf"><a class="goods_flLiA" href="<?php echo LinkTo('mall/index',$linkArr,array('area'=>$area_id,'business'=>$business_id));?>"><?php echo ($Business['business_name']); ?><em></em></a><a href="<?php echo LinkTo('mall/index',$linkArr,array('area'=>$area_id,'business'=>0));?>" class="goods_flLiFl">ｘ</a>
                                    <div class="goods_flLiLfk"><a href="<?php echo LinkTo('mall/index',$linkArr,array('area'=>$area_id,'business'=>0));?>">全部</a>
                                        <?php if(is_array($bizs)): foreach($bizs as $key=>$item): if(($item["area_id"]) == $area_id): ?>|<a <?php if(($item["business_id"]) == $business_id): ?>class="on"<?php endif; ?> href="<?php echo LinkTo('mall/index',$linkArr,array('area'=>$area_id,'business'=>$item['business_id']));?>"><?php echo ($item['business_name']); ?></a><?php endif; endforeach; endif; ?>
                                    </div>
                                </li>
                                <li class="goods_flLi goods_flLix">&gt;</li><?php endif; ?>
                        </ul>
                ...
                <?php if(empty($cat)): ?><li class="goods_flList">
                        ...
                        <div class="left goods_flList_r">
                            <a class="goods_flListA on" href="<?php echo LinkTo('mall/index');?>">全部</a>
                            <?php if(is_array($goodscate)): foreach($goodscate as $key=>$item): if(($item["parent_id"]) == "0"): ?><a class="goods_flListA" href="<?php echo LinkTo('mall/index',array('cat'=>$item['cate_id']));?>"><?php echo ($goodscate[$item['cate_id']]['cate_name']); ?></a><?php endif; endforeach; endif; ?>
                        </div>
                    </li><?php endif; ?>
                ...
                <?php if(!empty($cat) and empty($cate_id)): ?><li class="goods_flList">
                        <div class="left goods_flList_l">分类：</div>
                        <div class="left goods_flList_r">
                            <a class="goods_flListA on" href="<?php echo LinkTo('mall/index',array('cat'=>$cat));?>">全部</a>
                            <?php if(is_array($goodscate)): foreach($goodscate as $key=>$item): if(($item["parent_id"]) == $cat): ?><a class="goods_flListA" href="<?php echo LinkTo('mall/index',array('cat'=>$cat,'cate_id'=>$item['cate_id']));?>"><?php echo ($goodscate[$item['cate_id']]['cate_name']); ?></a><?php endif; endforeach; endif; ?>
                        </div>
                    </li><?php endif; ?>
                ...
                <?php if(empty($area_id)): ?><li class="goods_flList">
                        ...
                        <div class="left goods_flList_r">
                            ...
                            <?php if(is_array($areas)): foreach($areas as $key=>$item): if(($item["city_id"]) == $city_id): ?><a class="goods_flListA" href="<?php echo LinkTo('mall/index',$linkArr,array('area'=>$item['area_id']));?>"><?php echo ($item["area_name"]); ?></a><?php endif; endforeach; endif; ?>
                        </div>
                    </li><?php endif; ?>
               ...
               <?php if(is_array($TpGoodsAttribute)): foreach($TpGoodsAttribute as $key=>$item): ?><li class="goods_flList">
                        <div class="left goods_flList_l"><?php echo ($item["attr_name"]); ?>：</div>
                            <div class="left goods_flList_r">
                            
                            <?php $attr_id = trim($item['attr_id']); $v3 = 'values_'.$attr_id; $v2 = trim($v3); ?>
                            
                             	<a class="goods_flListA <?php if(empty($query[$v2])): ?>on<?php endif; ?> " href="<?php echo LinkTo('mall/index',$linkArr,array('attr_id'=>$attr_id,$v2=>'0'));?>">全部</a>
                                <?php if(is_array($item['attr_values'])): foreach($item['attr_values'] as $key=>$item2): $value = trim($item2); $attr_id = trim($item['attr_id']); $val2 = 'values_'.$attr_id; foreach($query as $kkk=>$vvv){ $querys[]= trim($vvv); } $item3 = trim($item2); ?>
                                    <a class="goods_flListA <?php if(in_array($item3,$querys)){?> on <?php }?> "  href="<?php echo LinkTo('mall/index',$linkArr,array('attr_id'=>$attr_id,$val2=>$value));?>"><?php echo ($item2); ?></a><?php endforeach; endif; ?>
                            </div>
            ...
            <ul>
             ...
             <?php if(is_array($list)): foreach($list as $key=>$item): ?><li class="nearbuy_cpLi">
                        <div class="sy_sjcpLi nearbuy_cpLik">
                            ...
                            <p class="sy_hottjbt"><?php echo tu_msubstr($item['title'],0,18,false);?></p>
                            <p class="sy_hottjp"><?php echo tu_msubstr($item['intro'],0,22,false);?></p>
                    ...
                    <ul>
                        <?php  $cache = cache(array('type'=>'File','expire'=> 3600)); $token = md5("Goods,views desc,end_date >= '{$today}' AND audit=1 AND closed=0 AND city_id = '{$city_id}',3600,0,6,,"); if(!$items= $cache->get($token)){ $items = D("Goods")->where("end_date >= '{$today}' AND audit=1 AND closed=0 AND city_id = '{$city_id}'")->order("views desc")->limit("0,6")->select(); $cache->set($token,$items); } ; $index=0; foreach($items as $item): $index++; ?><li>
                                <div class="qg-sp-liBox1">
                                    ...
                                    <p class="rap"><a target="_blank" href="<?php echo U('mall/detail',array('goods_id'=>$item['goods_id']));?>"><?php echo tu_msubstr($item['title'],0,12,false);?></a></p>
