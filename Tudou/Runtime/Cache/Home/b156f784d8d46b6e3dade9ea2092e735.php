...
<div class="clear"></div>
<style>
.Erreur_box {position: relative;margin-top: 20px;display: block;}
.Erreur_box .Erreur .clo a {text-decoration: none;margin: 0 10px; font-weight:bold}
</style>
...
<div class="Erreur_box">
    <div class="Erreur">
        ...
        <p class="clo">你可以访问<a href="<?php echo u('home/index/index');?>"><?php echo ($CONFIG["site"]["sitename"]); ?>首页</a>或<a href="javascript:location.reload(true);">刷新页面</a></p>
    </div>
</div>
<div class="footerOut">
