...
<div class="topOne">
 ...
 $views = unserialize(cookie('views')); $views = array_reverse($views, TRUE); if($views){ foreach($views as $v){ ?>
            ...
            <span>|</span>
            <li class="liOne"> <a class="liOneA" href="javascript:void(0);">我是企业<em>&nbsp;</em></a>
                <div class="list">
                    <ul>
                        <li><a href="<?php echo U('merchant/login/index');?>">企业登陆</a></li>
                    </ul>
                </div>
            </li>
            <span>|</span>
            ...
            <li class="liOne"> <a class="liOneA" href="javascript:void(0);">网站导航<em>&nbsp;</em></a>
                <div class="list">
                    ...
                    <li><a href="<?php echo U('merchant/index/index');?>">企业中心</a></li>
...
<li><a href="javascript:void(0);" <?php if($ctl == 'shop'){?> cur='true'<?php }?> rel="<?php echo u('home/shop/index');?>">企业</a></li>
...
<li><a href="javascript:void(0);" <?php if($ctl == 'mall'){?> cur='true'<?php }?>rel="<?php echo u('home/mall/index');?>">工作</a></li>
...
<style>
.sy_flexslider {width: 100%;}
.sy_partOne {margin-top: -320px;}
.homeloginbox{ z-index:8;position: relative;}
.tabRank{background: #fff;}
.sy_flsx {margin-top: 330px;border-top: 1px solid #dfdfdf;}
</style>
...
<div class="sy_partOne">
	...
	<div class="left sy_partOne_cate">
<style>
.menu_flklist2 {width:700px;}
</style>
    ...
    <div class="menu_fllist2">
            <div class="item2 bo" >
                <h3>
                    <div class="left ico ico_1"></div>
                        <div class="wz">
                            <a class="bt1" title="抢购频道" target="_blank" href="<?php echo U('tuan/index');?>">抢购频道</a>
                            <div class="bt2">
                               <?php $i2=0; ?>
                                <?php if(is_array($tuancates)): foreach($tuancates as $key=>$item3): if(($item3["parent_id"]) == "0"): $i2++;if($i2 <= 2){ ?>
                                    <a title="<?php echo ($item2["cate_name"]); ?>" target="_blank" href="<?php echo U('tuan/index',array('cat'=>$item3['cate_id']));?>"><?php echo msubstr($item3['cate_name'],0,4,'utf-8',false);?></a>
            ...
            <div class="menu_flklist2">
                <?php if(is_array($tuancates)): foreach($tuancates as $key=>$item): if(($item["parent_id"]) == "0"): $i++;if($i <= 8){ ?>
                        <div class="menu_fl2t">
                            <a title="<?php echo msubstr($item['cate_name'],0,8,'utf-8',false);?>" target="_blank" href="<?php echo U('tuan/index',array('cat'=>$item['cate_id']));?>"><?php echo msubstr($item['cate_name'],0,8,'utf-8',false);?></a>
                        </div>
        ...
        <div class="item2 bo" >
                <h3>
                    <div class="left ico ico_2"></div>
                        <div class="wz">
                            <a class="bt1" title="企业频道" target="_blank" href="<?php echo U('shop/index');?>">企业频道</a>
                            <div class="bt2">
                               <?php $i3=0; ?>
                                <?php if(is_array($shopcates)): foreach($shopcates as $key=>$item3): if(($item3["parent_id"]) == "0"): $i3++;if($i3 <= 2){ ?>
                                    <a title="<?php echo ($item2["cate_name"]); ?>" target="_blank" href="<?php echo U('shop/index',array('cat'=>$item3['cate_id']));?>"><?php echo msubstr($item3['cate_name'],0,4,'utf-8',false);?></a>
                                    <?php } endif; endforeach; endif; ?>
                           </div>
                        </div>
                    <div class="clear"></div>
            ...
            <div class="menu_flklist2">
                <?php if(is_array($shopcates)): foreach($shopcates as $key=>$item): if(($item["parent_id"]) == "0"): $i4++;if($i4 <= 8){ ?>
                        <div class="menu_fl2t">
                            <a title="<?php echo msubstr($item['cate_name'],0,8,'utf-8',false);?>" target="_blank" href="<?php echo U('shop/index',array('cat'=>$item['cate_id']));?>"><?php echo msubstr($item['cate_name'],0,8,'utf-8',false);?></a>
                        </div>
                        <div class="menu_fl2nr">
                            <?php $k4=0; ?>
        ...
        <div class="item2 bo" >
                <h3>
                    <div class="left ico ico_3"></div>
                        <div class="wz">
                            <a class="bt1" title="家政频道" target="_blank" href="<?php echo U('appoint/index');?>">家政频道</a>
                            <div class="bt2">
                               <?php $i50=0; ?>
                                <?php if(is_array($appointcates)): foreach($appointcates as $key=>$item3): if(($item3["parent_id"]) == "0"): $i50++;if($i50 <= 2){ ?>
                                    <a title="<?php echo ($item2["cate_name"]); ?>" target="_blank" href="<?php echo U('appoint/index',array('cat'=>$item3['cate_id']));?>"><?php echo msubstr($item3['cate_name'],0,4,'utf-8',false);?></a>
                                    <?php } endif; endforeach; endif; ?>
                           </div>
                        </div>
                    <div class="clear"></div>
            ...
            <div class="menu_flklist2">
                <?php if(is_array($appointcates)): foreach($appointcates as $key=>$item): if(($item["parent_id"]) == "0"): $i51++;if($i51 <= 8){ ?>
                        <div class="menu_fl2t">
                            <a title="<?php echo msubstr($item['cate_name'],0,8,'utf-8',false);?>" target="_blank" href="<?php echo U('appoint/index',array('cat'=>$item['cate_id']));?>"><?php echo msubstr($item['cate_name'],0,8,'utf-8',false);?></a>
                        </div>
                        <div class="menu_fl2nr">
                            <?php $k52=0; ?>
                             <?php if(is_array($appointcates)): foreach($appointcates as $key=>$item2): if(($item2["parent_id"]) == $item["cate_id"]): ?><a title="<?php echo ($item2['cate_name']); ?>" target="_blank" href="<?php echo U('appoint/index',array('cat'=>$item['cate_id'],'cate_id'=>$item2['cate_id']));?>"><?php echo ($item2['cate_name']); ?></a><?php endif; endforeach; endif; ?>
                        </div>
                       <?php } endif; endforeach; endif; ?>
            </div>
        </div>
        ...
        <div class="item2 bo" >
                <h3>
                    <div class="left ico ico_4"></div>
                        <div class="wz">
                            <a class="bt1" title="商城频道" target="_blank" href="<?php echo U('mall/index');?>">商城频道</a>
                            <div class="bt2">
                               <?php $i60=0; ?>
                                <?php if(is_array($goodscates)): foreach($goodscates as $key=>$item3): if(($item3["parent_id"]) == "0"): $i60++;if($i60 <= 2){ ?>
                                    <a title="<?php echo ($item2["cate_name"]); ?>" target="_blank" href="<?php echo U('mall/index',array('cat'=>$item3['cate_id']));?>"><?php echo msubstr($item3['cate_name'],0,4,'utf-8',false);?></a>
                                    <?php } endif; endforeach; endif; ?>
                           </div>
                        </div>
                    <div class="clear"></div>
            ...
            <div class="menu_flklist2">
                <?php if(is_array($goodscates)): foreach($goodscates as $key=>$item): if(($item["parent_id"]) == "0"): $i61++;if($i61 <= 8){ ?>
                        <div class="menu_fl2t">
                            <a title="<?php echo msubstr($item['cate_name'],0,8,'utf-8',false);?>" target="_blank" href="<?php echo U('mall/index',array('cat'=>$item['cate_id']));?>"><?php echo msubstr($item['cate_name'],0,8,'utf-8',false);?></a>
                        </div>
                        <div class="menu_fl2nr">
                            <?php $k62=0; ?>
                             <?php if(is_array($goodscates)): foreach($goodscates as $key=>$item2): if(($item2["parent_id"]) == $item["cate_id"]): ?><a title="<?php echo ($item2['cate_name']); ?>" target="_blank" href="<?php echo U('mall/index',array('cat'=>$item['cate_id'],'cate_id'=>$item2['cate_id']));?>"><?php echo ($item2['cate_name']); ?></a><?php endif; endforeach; endif; ?>
                        </div>
                       <?php } endif; endforeach; endif; ?>
            </div>
        </div>
         ...
         <div class="item2 bo" >
                <h3>
                    <div class="left ico ico_5"></div>
                        <div class="wz">
                            <a class="bt1" title="分类信息" target="_blank" href="<?php echo U('life/index');?>">分类信息</a>
                            <div class="bt2">
                               <?php $i70=0; ?>
                                <?php if(is_array($channelmeans)): foreach($channelmeans as $key=>$item): if($item['channel_id'] == $k): $i70++;if($i70 <= 2){ ?>
                                    <a title="<?php echo msubstr($item,0,4,'utf-8',false);?>" target="_blank" href="<?php echo U('life/index',array('channel'=>$key));?>"><?php echo msubstr($item,0,4,'utf-8',false);?></a>
                                    <?php } endif; endforeach; endif; ?>
                           </div>
                        </div>
                    <div class="clear"></div>
            ...
            <div class="menu_flklist2">
                <?php if(is_array($channelmeans)): foreach($channelmeans as $key3=>$item2): $i71++;if($i71 <= 8){ ?>
                        <div class="menu_fl2t">
                            <a title="<?php echo ($item2); ?>" target="_blank" href="<?php echo U('life/index',array('channel'=>$key));?>"><?php echo ($item2); ?></a>
                        </div>
                        <div class="menu_fl2nr">
                            <?php $k72=0; ?>
                             <?php if(is_array($lifecates)): foreach($lifecates as $key=>$item3): if($item3['channel_id'] == $key3): ?><a title="<?php echo ($item3['cate_name']); ?>" target="_blank" href="<?php echo U('life/index',array('channel'=>$key3,'cat'=>$item3['cate_id']));?>"><?php echo ($item3['cate_name']); ?></a><?php endif; endforeach; endif; ?>
                        </div>
         ...
         <div class="item2 bo" >
                <h3>
                    <div class="left ico ico_6"></div>
                        <div class="wz">
                            <a class="bt1" title="商城频道" target="_blank" href="<?php echo U('edu/course');?>">教育频道</a>
                            <div class="bt2">
                               <?php $i80=0; ?>
                                <?php if(is_array($educates)): foreach($educates as $key=>$item3): if(($item3["parent_id"]) == "0"): $i80++;if($i80 <= 2){ ?>
                                    <a title="<?php echo ($item2["cate_name"]); ?>" target="_blank" href="<?php echo U('edu/course',array('cat'=>$item3['cate_id']));?>"><?php echo msubstr($item3['cate_name'],0,4,'utf-8',false);?></a>
                                    <?php } endif; endforeach; endif; ?>
                           </div>
                        </div>
                    <div class="clear"></div>
            ...
            <div class="menu_flklist2">
                <?php if(is_array($educates)): foreach($educates as $key=>$item): if(($item["parent_id"]) == "0"): $i81++;if($i81 <= 8){ ?>
                        <div class="menu_fl2t">
                            <a title="<?php echo msubstr($item['cate_name'],0,8,'utf-8',false);?>" target="_blank" href="<?php echo U('edu/course',array('cat'=>$item['cate_id']));?>"><?php echo msubstr($item['cate_name'],0,8,'utf-8',false);?></a>
                        </div>
                        <div class="menu_fl2nr">
                            <?php $k82=0; ?>
                             <?php if(is_array($educates)): foreach($educates as $key=>$item2): if(($item2["parent_id"]) == $item["cate_id"]): ?><a title="<?php echo ($item2['cate_name']); ?>" target="_blank" href="<?php echo U('edu/course',array('cat'=>$item['cate_id'],'cate_id'=>$item2['cate_id']));?>"><?php echo ($item2['cate_name']); ?></a><?php endif; endforeach; endif; ?>
                        </div>
                       <?php } endif; endforeach; endif; ?>
            </div>
        </div>
        ...
        <div class="item2 bo" >
                <h3>
                    <div class="left ico ico_7"></div>
                        <div class="wz">
                            <a class="bt1" title="五折卡频道" target="_blank" href="<?php echo U('zhe/index');?>">五折卡频道</a>
                            <div class="bt2">
                               <?php $i90=0; ?>
                                <?php if(is_array($shopcates)): foreach($shopcates as $key=>$item3): if(($item3["parent_id"]) == "0"): $i90++;if($i90 <= 2){ ?>
                                    <a title="<?php echo ($item2["cate_name"]); ?>" target="_blank" href="<?php echo U('zhe/index',array('cat'=>$item3['cate_id']));?>"><?php echo msubstr($item3['cate_name'],0,4,'utf-8',false);?></a>
                                    <?php } endif; endforeach; endif; ?>
                           </div>
                        </div>
                    <div class="clear"></div>
            ...
            <div class="menu_flklist2">
                <?php if(is_array($shopcates)): foreach($shopcates as $key=>$item): if(($item["parent_id"]) == "0"): $i91++;if($i91 <= 8){ ?>
                        <div class="menu_fl2t">
                            <a title="<?php echo msubstr($item['cate_name'],0,8,'utf-8',false);?>" target="_blank" href="<?php echo U('zhe/index',array('cat'=>$item['cate_id']));?>"><?php echo msubstr($item['cate_name'],0,8,'utf-8',false);?></a>
                        </div>
                        <div class="menu_fl2nr">
                            <?php $k92=0; ?>
                             <?php if(is_array($shopcates)): foreach($shopcates as $key=>$item2): if(($item2["parent_id"]) == $item["cate_id"]): ?><a title="<?php echo ($item2['cate_name']); ?>" target="_blank" href="<?php echo U('zhe/index',array('cat'=>$item['cate_id'],'cate_id'=>$item2['cate_id']));?>"><?php echo ($item2['cate_name']); ?></a><?php endif; endforeach; endif; ?>
                        </div>
                       <?php } endif; endforeach; endif; ?>
            </div>
        </div>
       ...
       <div class="item2 bo" >
                <h3>
                    <div class="left ico ico_8"></div>
                        <div class="wz">
                            <a class="bt1" title="贴吧频道" target="_blank" href="<?php echo U('thread/index');?>">贴吧频道</a>
                            <div class="bt2">
                               <?php $i100=0; ?>
                                <?php if(is_array($threadcates)): foreach($threadcates as $key=>$item3): $i100++;if($i100 <= 2){ ?>
                                    <a title="<?php echo ($item2["cate_name"]); ?>" target="_blank" href="<?php echo U('thread/lists',array('cate_id'=>$item3['cate_id']));?>"><?php echo msubstr($item3['cate_name'],0,4,'utf-8',false);?></a>
                                    <?php } endforeach; endif; ?>
                           </div>
                        </div>
                    <div class="clear"></div>
            ...
            <div class="menu_flklist2">
                        <div class="menu_fl2t">
                            <a title="贴吧频道" href="<?php echo U('thread/index');?>">贴吧频道</a>
                        </div>
                        <div class="menu_fl2nr">
                            <?php $k102=0; ?>
                             <?php if(is_array($threadcates)): foreach($threadcates as $key=>$item2): ?><a title="<?php echo ($item2['cate_name']); ?>" target="_blank" href="<?php echo U('thread/lists',array('cate_id'=>$item2['cate_id']));?>"><?php echo ($item2['cate_name']); ?></a><?php endforeach; endif; ?>
                        </div>
            </div>
        </div>
    ...
    <div class="left sy_partOne_r">
        ...
        <ul class="sy_flsx">
            ...
            <?php $i=0; $Area = D('Area')->where(array('city_id'=>$city_id))->select(); ?>
            <?php if(is_array($Area)): foreach($Area as $key=>$item): $i++;if($i<=15){ ?>
			...
			<li class="bg_3">
                <h3><em class="ico ico_3"></em>热门工作</h3>
            <?php $i=0; ?>
            <?php if(is_array($goodscates)): foreach($goodscates as $key=>$item): $i++;if($i<10){ ?>
                <?php if($item['parent_id'] == 0): ?><a title="<?php echo ($item["cate_name"]); ?>" target="_blank" href="<?php echo U('mall/index',array('cat'=>$item['cate_id']));?>"><?php echo ($item['cate_name']); ?></a>
                    <?php else: ?>
                    <a title="<?php echo ($item["cate_name"]); ?>" target="_blank" href="<?php echo U('mall/index',array('cat'=>$item['parent_id'],'cate_id'=>$item['cate_id']));?>"><?php echo ($item['cate_name']); ?></a><?php endif; ?>
                <?php } ?>
        ...
        <div class="clearfix">
            ...
            <dl class="tabRank" id="tabRank">
                ...
                <dd class="bd">
                    ...
                    <?php  $cache = cache(array('type'=>'File','expire'=> 600)); $token = md5("Article,closed=0,create_time desc,0,5,600,,"); if(!$items= $cache->get($token)){ $items = D("Article")->where("closed=0")->order("create_time desc")->limit("0,5")->select(); $cache->set($token,$items); } ; $index=0; foreach($items as $item): $index++; ?><a href="<?php echo U('news/detail',array('article_id'=>$item['article_id']));?>" target="_blank">
                        【新闻】<?php echo tu_msubstr($item['title'],0,10,false);?><i class="icons-hot"></i></a> <?php endforeach; ?>	
                    </div>
                    <div style="width:209px;" class="listA-box">
                        ...
                        【信息】<?php echo tu_msubstr($item['title'],0,10,false);?><i class="icons-hot"></i></a> <?php endforeach; ?>	
                    </div>
                </dd>
            </dl>  
            ...
            <a href="<?php echo u('home/shop/apply');?>"  target="_blank" class="fl">免费企业入驻</a>
...
<div class="nearbuy_cpList1 sy_buy_list_box">
                            ...
                            $(function () {
                                ...
                                $('#tuan_code_<?php echo ($item["tuan_id"]); ?>').qrcode(str);
                                    ...
                                    <div class="sy_sjcpDwNr" style="padding-top:10px;">
                                        ...
                                        <?php else: ?>
                                        <p>此企业已有<span><?php echo ($shops[$item['shop_id']]['fans_num']); ?></span>个粉丝 </p><?php endif; ?>
                                        <a href="<?php echo U('tuan/detail',array('tuan_id'=>$item['tuan_id']));?>"><div class="sy_sjcpwx"  id="tuan_code_<?php echo ($item["tuan_id"]); ?>"></div></a>
                                        <div class="sy_sjcpCz">
                       <a class="radius3 sy_sjcpCzA" href="<?php echo U('shop/detail',array('shop_id'=>$item['shop_id']));?>">企业<em>&nbsp;</em></a>
 ...
 <!--首页抢购部分结束-->       
    ...
    <!--首页商城部分开始-->
    <div class="sy_FloorBt" data="top_1" id="floor2">
        <div class="left sy_FloorBtz"><span class="bt cl_1">热卖工作</span>
            <span class="sy_mall_tab">
                <?php $i=0; ?>       
                <?php if(is_array($goodscates)): foreach($goodscates as $key=>$item3): if(($item3["parent_id"]) == "0"): $i++;if($i <= 10){ ?>
                    <a target="_blank" <?php if($i == 1) echo 'class="on"'; ?> title="<?php echo ($item2["cate_name"]); ?>抢购" href="<?php echo LinkTo('mall/index',array('cat'=>$item3['cate_id']));?>"><?php echo ($item3["cate_name"]); ?></a>
                    <?php } endif; endforeach; endif; ?>
            </span>
        </div>
        <div class="right"><a  title="更多工作" target="_blank" href="<?php echo U('mall/index');?>">更多&gt;&gt;</a></div>
    </div>
 ...
 <!--首页商城部分结束-->   
  ...
  <!--首页订座部分开始-->
                ...
                <div class="sy_seatSwitch1" style="display:block;">
                    ...
                    <form action="<?php echo U('booking/lists');?>" method="post">
                        ...
                        <select name="area_id" class="addr">
                            <?php if(is_array($Area)): $i = 0; $__LIST__ = $Area;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i; if(($item["city_id"]) == $city_id): ?><option value="<?php echo ($item["area_id"]); ?>"><?php echo ($item["area_name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                        <div class="num_box">
   ...
   <div class="sy_FloorBt" data="top_7" id="floor7">
        <div class="left sy_FloorBtz"><i class="ico_5"></i><span class="bt cl_5">酒店</span></div>
        <div class="right"><a target="_blank" href="<?php echo U('hotels/index');?>">更多&gt;&gt;</a></div>
    </div>
    <div class="hotel_list_box">
        <ul>
            <?php  $cache = cache(array('type'=>'File','expire'=> 600)); $token = md5("Hotel,600,audit=1 AND closed=0 AND  city_id=$city_id,0,3,create_time desc,,"); if(!$items= $cache->get($token)){ $items = D("Hotel")->where("audit=1 AND closed=0 AND  city_id=$city_id")->order("create_time desc")->limit("0,3")->select(); $cache->set($token,$items); } ; $index=0; foreach($items as $item): $index++; ?><li class="hotel_list">
                <div class="pub_img"><a href="<?php echo U('hotels/detail',array('hotel_id'=>$item['hotel_id']));?>"><img src="<?php echo config_img($item['photo']);?>" width="380" height="300" /><?php if($item['have_tuan'] == 1): ?><span class="tag">团</span><?php endif; ?></a></div>
                <div class="pub_wz">
                	<h3><a href="<?php echo U('hotels/detail',array('hotel_id'=>$item['hotel_id']));?>"><?php echo ($item["hotel_name"]); ?></a></h3>
                    <div class="box">
                    	<div class="left">
   ...
   <div class="sy_FloorBt" data="top_8" id="floor8">
        <div class="left sy_FloorBtz"><i class="ico_5"></i><span class="bt cl_5">农家乐</span></div>
        <div class="right"><a target="_blank" href="<?php echo U('farm/index');?>">更多&gt;&gt;</a></div>
    </div>
    <div class="farm_recmd">
        <ul>
            <?php  $cache = cache(array('type'=>'File','expire'=> 600)); $token = md5("Farm,600,audit=1 AND closed=0 AND  city_id=$city_id,0,4,create_time desc,,"); if(!$items= $cache->get($token)){ $items = D("Farm")->where("audit=1 AND closed=0 AND  city_id=$city_id")->order("create_time desc")->limit("0,4")->select(); $cache->set($token,$items); } ; $index=0; foreach($items as $item): $index++; ?><li class="list">
                <div class="pub_img"><a href="<?php echo U('farm/detail',array('farm_id'=>$item['farm_id']));?>">
                <img src="<?php echo config_img($item['photo']);?>" width="285" height="200" /><span class="tag">热门农家乐</span></a></div>
                <div class="pub_wz">
                	<p class="bt overflow_clear"><a href="#" class="blackcl3"><b>[<?php echo ($citys[$item['city_id']]['name']); ?>]</b> <?php echo ($item["farm_name"]); ?></a></p>
                    <P class="graycl line2">地址：<?php echo ($item["addr"]); ?></P>
                    <div class="box">
                        <p class="left fontcl1">好评：<?php echo intval(($item['good_comments']/$item['comments'])*100); ?>%</p>
                        <p class="right fontcl1">￥<big><?php echo ($item["price"]); ?></big>起</p>
                    </div>
                </div>
            </li> <?php endforeach; ?> 
        </ul>
   ...
   <!--首页农家乐结束-->  
    ...
    <div class="sy_FloorBt" data="top_6" id="floor6">
        <div class="left sy_FloorBtz"><i class="ico_6"></i><span class="bt cl_6">服务中心</span></div>
        <div class="right"><a target="_blank" href="<?php echo U('appoint/index');?>">更多&gt;&gt;</a></div>
    </div>
    
    <div class="sy_doorSer_list">
        <ul>
                  <li>
                        <a href="<?php echo U('appoint/index',array('cat'=>1));?>">
                            <i class="ico_1"></i>
                            <h3></h3>
                            <p>家政服务中心</p>
                        </a>
                    </li>                <li>
                        <a href="<?php echo U('appoint/index',array('cat'=>2));?>">
                            <i class="ico_2"></i>
                            <h3></h3>
                            <p>家庭服务中心</p>
                        </a>
                    </li>                <li>
                        <a href="<?php echo U('appoint/index',array('cat'=>3));?>">
                            <i class="ico_3"></i>
                            <h3></h3>
                            <p>跑腿服务中心</p>
                        </a>
                    </li>                <li>
                        <a href="<?php echo U('appoint/index',array('cat'=>4));?>">
                            <i class="ico_4"></i>
                            <h3></h3>
                            <p>建房服务中心</p>
                        </a>
                    </li>                <li>
                        <a href="<?php echo U('appoint/index',array('cat'=>5));?>">
                            <i class="ico_5"></i>
                            <h3></h3>
                            <p>宴请服务中心</p>
                        </a>
                    </li>                <li>
                        <a href="<?php echo U('appoint/index',array('cat'=>6));?>">
                            <i class="ico_6"></i>
                            <h3></h3>
                            <p>网络服务中心</p>
                        </a>
                    </li>                <li>
                        <a href="<?php echo U('appoint/index',array('cat'=>7));?>">
                            <i class="ico_7"></i>
                            <h3></h3>
                            <p>外出服务中心</p>
                        </a>
                    </li>                <li>
                        <a href="<?php echo U('appoint/index',array('cat'=>8));?>">
                            <i class="ico_8"></i>
                            <h3></h3>
                            <p>电话服务中心</p>
                        </a>
...
<script src="/themes/default/Home/statics/js/common2017.js"></script>
...
<div class="inforWrap heTabs clearfix" id="tab_ajax_02">
	<div class="hd">
		...
		<div class="tabs">
			<ul class="tab-hd clearfix">
				<li class="item selected" data-cat="live_ajax_0"><a href="<?php echo LinkTo('life/index',array('channel'=>1));?>" target="_blank">二手</a></li>
				<li class="item" data-cat="live_1"><a href="<?php echo LinkTo('life/index',array('channel'=>2));?>" target="_blank">车辆</a></li>
                <li class="item" data-cat="live_2"><a href="<?php echo LinkTo('life/index',array('channel'=>3));?>" target="_blank">求职</a></li>
                <li class="item" data-cat="live_3"><a href="<?php echo LinkTo('life/index',array('channel'=>4));?>" target="_blank">交友</a></li>
                <li class="item" data-cat="live_4"><a href="<?php echo LinkTo('life/index',array('channel'=>5));?>" target="_blank">房屋</a></li>
                <li class="item" data-cat="live_5"><a href="<?php echo LinkTo('life/index',array('channel'=>6));?>" target="_blank">培训</a></li>
                <li class="item" data-cat="live_6"><a href="<?php echo LinkTo('life/index',array('channel'=>7));?>" target="_blank">招聘</a></li>
				<li><a href="<?php echo U('life/index');?>" target="_blank">更多</a></li>
			</ul>
		</div>
	</div>
	<div class="liveCon clearfix">
		<div class="picList">
			<ul class="clearfix">
             <?php  $cache = cache(array('type'=>'File','expire'=> 280)); $token = md5("Life,closed=0 AND audit=1 AND city_id IN ({$city_ids}),views desc,0,4,280,,"); if(!$items= $cache->get($token)){ $items = D("Life")->where("closed=0 AND audit=1 AND city_id IN ({$city_ids})")->order("views desc")->limit("0,4")->select(); $cache->set($token,$items); } ; $index=0; foreach($items as $item): $index++; ?><li>
                
					<div class="pic"><a href="<?php echo U('life/detail',array('life_id'=>$item['life_id']));?>" target="_blank"><img src="<?php echo config_img($item['photo']);?>" ></a></div>
					<div class="title"><a href="<?php echo U('life/detail',array('life_id'=>$item['life_id']));?>" target="_blank"><?php echo tu_msubstr($item['title'],0,16);?></a></div>
				</li> <?php endforeach; ?>
		...
		<div class="conn">
			<div class="touban">
				<ul class="news clearfix tab-cont" data-success="1" style="display: block;">
                <?php if(is_array($list_channel_1)): foreach($list_channel_1 as $key=>$var): ?><li><a href="<?php echo U('life/index',array('cat'=>$var['cate_id']));?>" target="_blank" class="gray">[<?php echo ($var["cate_name"]); ?>]</a> 
                    <a href="<?php echo U('life/detail',array('life_id'=>$var['life_id']));?>" target="_blank" style="color:; font-weight:;"><?php echo tu_msubstr($var['title'],0,16);?></a><em><?php echo (date("Y-m-d",$var["create_time"])); ?></em></li><?php endforeach; endif; ?>   
				</ul>
				<ul class="news clearfix tab-cont" data-success="1" style="display: none;">
                
                <?php if(is_array($list_channel_2)): foreach($list_channel_2 as $key=>$var): ?><li><a href="<?php echo U('life/index',array('cat'=>$var['cate_id']));?>" target="_blank" class="gray">[<?php echo ($var["cate_name"]); ?>]</a> 
                    <a href="<?php echo U('life/detail',array('life_id'=>$var['life_id']));?>" target="_blank" style="color:; font-weight:;"><?php echo tu_msubstr($var['title'],0,16);?></a><em><?php echo (date("Y-m-d",$var["create_time"])); ?></em></li><?php endforeach; endif; ?> 
               ...
               <?php if(is_array($list_channel_3)): foreach($list_channel_3 as $key=>$var): ?><li><a href="<?php echo U('life/index',array('cat'=>$var['cate_id']));?>" target="_blank" class="gray">[<?php echo ($var["cate_name"]); ?>]</a> 
                    <a href="<?php echo U('life/detail',array('life_id'=>$var['life_id']));?>" target="_blank" style="color:; font-weight:;"><?php echo tu_msubstr($var['title'],0,16);?></a><em><?php echo (date("Y-m-d",$var["create_time"])); ?></em></li><?php endforeach; endif; ?> </ul> 
				...
				<ul class="news clearfix loadding tab-cont" data-success="0" style="display:none;">
                 <?php if(is_array($list_channel_4)): foreach($list_channel_4 as $key=>$var): ?><li><a href="<?php echo U('life/index',array('cat'=>$var['cate_id']));?>" target="_blank" class="gray">[<?php echo ($var["cate_name"]); ?>]</a> 
                    <a href="<?php echo U('life/detail',array('life_id'=>$var['life_id']));?>" target="_blank" style="color:; font-weight:;"><?php echo tu_msubstr($var['title'],0,16);?></a><em><?php echo (date("Y-m-d",$var["create_time"])); ?></em></li><?php endforeach; endif; ?> 
                </ul>
				<ul class="news clearfix loadding tab-cont" data-success="0" style="display:none;">
                 <?php if(is_array($list_channel_5)): foreach($list_channel_5 as $key=>$var): ?><li><a href="<?php echo U('life/index',array('cat'=>$var['cate_id']));?>" target="_blank" class="gray">[<?php echo ($var["cate_name"]); ?>]</a> 
                    <a href="<?php echo U('life/detail',array('life_id'=>$var['life_id']));?>" target="_blank" style="color:; font-weight:;"><?php echo tu_msubstr($var['title'],0,16);?></a><em><?php echo (date("Y-m-d",$var["create_time"])); ?></em></li><?php endforeach; endif; ?> 
                </ul>
				<ul class="news clearfix loadding tab-cont" data-success="0" style="display:none;">
                 <?php if(is_array($list_channel_6)): foreach($list_channel_6 as $key=>$var): ?><li><a href="<?php echo U('life/index',array('cat'=>$var['cate_id']));?>" target="_blank" class="gray">[<?php echo ($var["cate_name"]); ?>]</a> 
                    <a href="<?php echo U('life/detail',array('life_id'=>$var['life_id']));?>" target="_blank" style="color:; font-weight:;"><?php echo tu_msubstr($var['title'],0,16);?></a><em><?php echo (date("Y-m-d",$var["create_time"])); ?></em></li><?php endforeach; endif; ?> 
                </ul>
				<ul class="news clearfix loadding tab-cont" data-success="0" style="display:none;">
                 <?php if(is_array($list_channel_7)): foreach($list_channel_7 as $key=>$var): ?><li><a href="<?php echo U('life/index',array('cat'=>$var['cate_id']));?>" target="_blank" class="gray">[<?php echo ($var["cate_name"]); ?>]</a> 
                    <a href="<?php echo U('life/detail',array('life_id'=>$var['life_id']));?>" target="_blank" style="color:; font-weight:;"><?php echo tu_msubstr($var['title'],0,16);?></a><em><?php echo (date("Y-m-d",$var["create_time"])); ?></em></li><?php endforeach; endif; ?> 
                </ul>
			</div>
		</div>
                ...
                <div class="footNavLi">
                    <ul>
                        ...
                        <li class="footerLi">
                            ...
                            <ul class="list">
                                <li><a href="<?php echo u('home/shop/apply');?>">企业入驻</a></li>
                                <li><a target="_blank" title="广告合作" href="<?php echo u('home/article/system',array('content_id'=>5));?>">广告合作</a></li>
                                <li><a href="<?php echo u('merchant/login/index');?>">企业后台</a></li>
                            </ul>
                        </li>
                        <li class="footerLi">
