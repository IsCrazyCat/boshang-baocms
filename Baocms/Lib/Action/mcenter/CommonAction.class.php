  ...
  class CommonAction extends Action {
    ...
    protected function _initialize() {
        ...
        if ( empty( $this->uid ) )
        {
            ...
            header( "Location: ".u( "mobile/passport/wxlogin" ) );
            exit( );
        }
		...
		$this->assign('open_tieba',$open_tieba = $this->_CONFIG['operation']['thread']); //赋值论坛
		$this->assign('open_thread',$open_tieba = $this->_CONFIG['operation']['thread']); //赋值论坛
		$this->assign('open_news',$open_news = $this->_CONFIG['operation']['news']); //赋值商讯
