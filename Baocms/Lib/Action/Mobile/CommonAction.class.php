    ...
    protected function mobile(){
        ...
        if ($this->isPost()) {
            ...
            /*if ($yzm != $s_code) {
                ...
                $this->ajaxReturn(array('status' => 'error', 'msg' => '验证码不正确1！'));
            ...
            if (D('Users')->save($data)) {
                ...
                $this->ajaxReturn(array('status' => 'success', 'msg' => '恭喜您通过手机认证3！'));
    ...
    protected function mobile2(){
        ...
        if ($this->isPost()) {
            ...
            /*if ($yzm != $s_code) {
                ...
                $this->ajaxReturn(array('status' => 'error', 'msg' => '验证码不正确2！'));
            ...
            if (D('Users')->save($data)) {
				D('Users')->getUserByMobile($mobile);//俺的添加 手机认证 积分获得
