...
class AllAction extends CommonAction {
    public function index(){
		...
		$list_thread=$Thread->Field('"论坛" as t_name,"thread/detail" as t_url,"thread_id" as t_param,thread_id as t_id,thread_name as t_title,photo as t_photo,FROM_UNIXTIME(create_time,"%Y-%m-%d") as t_note')->order($orderby)->where($where_thread)->select();
