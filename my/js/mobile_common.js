...
function WebMessageShow(data){
	...
	if(!$('#'+newOrderId)[0]){
		...
		divs.id = newOrderId;
		$('body').append(divs);
		divs.innerHTML = '<div class="hd">您有<span id="WebMessageNum">0</span>条新信息</div><div class="bd" id="WebMessageInner"></div><a href="javascript:void(0);" class="close">收起</a><a href="javascript:void(0);" class="remove">移除</a>';
	...
	var txt = $('<div class="item tplid_'+idata.tplid+'">'+idata.title+'<p class="date">'+idata.dtappenddate+'</p><span class="panel"><a href="'+idata.smsurl+'" class="view" data-tplid="'+idata.tplid+'">查看详细</a> <a href="javascript:void(0);" class="del">忽略</a></span><s class="s"></s></div>');
